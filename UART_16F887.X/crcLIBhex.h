//
// created and tested 07-May-2014. Originally required for a custom 
// packet protocol as implemented on PIC16 and PIC18 processors.
//
// I am sharing this not so much to support the Pro's and experts
// of mikroC� but home users and hobbyist's.
//
// enjoy! -
//
// Regards, keedo.
//
//-----------------------------------------------------------------------//
//             CHECKSUM and CYCLIC REDUNDANCY CHECK ROUTINES             //
//-----------------------------------------------------------------------//
//              Online test calculators used for verification            //
// ADLER32   -> http://www.miniwebtool.com/adler32-checksum-calculator/  //
// CRC-CCITT -> http://www.lammertbies.nl/comm/info/crc-calculation.html //
...
//   TEST RESULTS                                                        //
//                                                                       //
//  checksum   ("ABCD1234", 8);  -> 0xD4                                 //
//  checksum   ("abcd1234", 8);  -> 0x54                                 //
//  checksum   ("AbCd4321", 8);  -> 0x14                                 //
//  crc8       ("ABCD1234", 8);  -> 0x9C                                 //
//  crc8       ("abcd1234", 8);  -> 0x95                                 //
//  crc8       ("AbCd4321", 8);  -> 0x5A                                 //
//  crc16      ("ABCD1234", 8);  -> 0xE71B                               //
//  crc16      ("abcd1234", 8);  -> 0xCF39                               //
//  crc16      ("AbCd4321", 8);  -> 0x69B8                               //
//  fletcher16 ("ABCD1234", 8);  -> 0xB8D5                               //
//  fletcher16 ("abcd1234", 8);  -> 0xFB56                               //
//  fletcher16 ("AbCd4321", 8);  -> 0x4416                               //
//  crc32      ("ABCD1234", 8);  -> 0xCD99C0BE                           //
//  crc32      ("abcd1234", 8);  -> 0x3D3FB146                           //
//  crc32      ("AbCd4321", 8);  -> 0x9C8889ED                           //
//  adler32    ("ABCD1234", 8);  -> 0x08B801D5                           //
//  adler32    ("abcd1234", 8);  -> 0x0BF80255                           //
//  adler32    ("AbCd4321", 8);  -> 0x0A420215                           //
//-----------------------------------------------------------------------//
/*
...
//----------------------------------------//
// 8 Bit CRC -> longitudinal parity check //
//----------------------------------------//
//
//
...
//--------------------------------------------------------//
// 16-bit CRC based on CCITT 16-bit xmodem implementation //
//--------------------------------------------------------//
//
//
